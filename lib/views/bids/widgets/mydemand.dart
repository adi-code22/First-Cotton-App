import 'package:first_cotton/views/demanddetailspage/demanddetails.dart';
...
class MyDemand extends StatefulWidget {
  const MyDemand({Key? key}) : super(key: key);

  @override
  State<MyDemand> createState() => _MyDemandState();
}

class _MyDemandState extends State<MyDemand> {
