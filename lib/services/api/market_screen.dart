class MarketLots {
  ...
  MarketLots({this.status, this.requestedAt, this.data});

  MarketLots.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['lotsResult'] != null) {
      ...
      List<dynamic> jsonArray = json['lotsResult'];

      jsonArray.sort((a, b) => a['lotNumber'].compareTo(b['lotNumber']));
